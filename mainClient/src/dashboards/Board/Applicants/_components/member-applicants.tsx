...
export default function MemberApplicants({
    column
}: Table) {
              ...
              return (
                ...
                >
                    {Object.values(row).map((column, index) => (
                        (index === 0) 
                        ? (
                            <td id={labelId} key={index} scope='row' className='font-semibold cursor-pointer hover:underline'  onClick={(e) => {e.stopPropagation(); alert(JSON.stringify(row))}}>
                                {column}
                            </td>
                        ) : (
                            <td key={index} >
                ...
                <td>
                    <Button size="sm" variant="plain" color="neutral" onClick={(e) => {e.stopPropagation(); alert(JSON.stringify(row))}}>
                      Edit
                    </Button>
                  </td>
                  <td>
                    <Button size="sm" variant="soft" color="danger" onClick={(e) => {e.stopPropagation(); alert(JSON.stringify(row))}}>
                      Delete
                    </Button>
