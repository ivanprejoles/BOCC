...
const Announcement = () => {
    ...
    return (  
        <div className="h-full w-full overflow-hidden relative flex flex-row pr-2">
            ...
            <div className="hidden md:block md:w-2/4 h-full sticky top-0 right-0 overflow-y-auto scroll px-3 space-y-2 py-2">
                <p>Announcement</p>
                <Card className='overflow-x-hidden shadow-none bg-transparent border-none ring-0 hover:bg-[#E4E6E9] cursor-pointer'>
